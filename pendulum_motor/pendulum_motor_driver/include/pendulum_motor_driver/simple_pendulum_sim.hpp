...
#ifndef PENDULUM_MOTOR_DRIVER__SIMPLE_PENDULUM_SIM_HPP_
#define PENDULUM_MOTOR_DRIVER__SIMPLE_PENDULUM_SIM_HPP_
#include <cmath>
#include <chrono>
...
public:
  ...
  virtual void update_command_data(const pendulum_ex_msgs::msg::JointCommandEx & msg)
  {
  ...
  virtual void update_sensor_data(pendulum_ex_msgs::msg::JointStateEx & msg)
  {
...
#endif  // PENDULUM_MOTOR_DRIVER__SIMPLE_PENDULUM_SIM_HPP_
